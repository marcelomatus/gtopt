...
If you have the `compare-pandapower` script installed:

```bash
cd scripts
compare-pandapower --case ieee_case57 --gtopt-output ../output/
```
...
- [compare-pandapower.md](compare-pandapower.md) — Validating gtopt results
