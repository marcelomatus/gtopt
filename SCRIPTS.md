...
preparing, converting, and visualising data for use with gtopt.
...
This registers the `gtopt-diagram`, `plp2gtopt`, `pp2gtopt`, `igtopt`, and
`cvs2parquet` commands on your `PATH`.  An editable install is useful during
development:
