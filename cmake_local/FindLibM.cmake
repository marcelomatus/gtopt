# FindLibM.cmake: Check for the presence of the LibM headers and libraries AF,
# 2011-10-26
#
# Copyright 2010-2013 AstroFloyd - astrofloyd.org
#
# This file is part of the CMakeFiles package, see: http://cmakefiles.sf.net/
#
...
#
# This CMake module defines the following variables: LibM_FOUND        =  Libraries
# and headers found; TRUE/FALSE LibM_INCLUDES     =  Path to the LibM header files
# LibM_LIBRARIES    =  Path to all parts of the LibM libraries LibM_LIBRARY_DIR  =
# Path to the directory containing the LibM libraries

# Standard locations where to look for required components: include( CMakeLocations )
