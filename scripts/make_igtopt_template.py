...
_INTRO_LINES = [
    ...
    ("", ""),
    (
        "Generated by make_igtopt_template.py — re-run to refresh after C++ changes.",
        "FOOTER",
    ),
]
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap = argparse.ArgumentParser(
        description=("Generate the gtopt igtopt Excel template from C++ JSON headers."),
    ...
    ap.add_argument(
        "--header-dir",
        metavar="DIR",
        help=("Path to include/gtopt (auto-detected from the repo root if omitted)"),
    )
    ap.add_argument(
        "-o",
        "--output",
