...
reservoirs, waterways, turbines, and filtration, (iii)~a generic water
rights layer for irrigation agreement constraints with volume-dependent
dynamic bounds, (iv)~three solution methods including SDDP and cascade
decomposition, (v)~native Apache Parquet I/O for large time-series, and
(vi)~a comprehensive Python toolchain for data preparation and
cross-validation.
