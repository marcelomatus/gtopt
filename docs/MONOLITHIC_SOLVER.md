...
into the last phase of each scene's LP before solving.  This adds a
future-cost variable ($\alpha$) to the objective and constrains it
via the loaded cuts:
...
### 5.3 Single-Phase SDDP Fallback
