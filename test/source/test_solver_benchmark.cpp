...
// Removed: "Solver benchmark: resolve with basis reuse"
// Was a performance-only benchmark (no correctness value) that aborted
// intermittently under parallel ctest due to memory/CPU contention from
// building a large LP (200×20×12) concurrently with other tests.
