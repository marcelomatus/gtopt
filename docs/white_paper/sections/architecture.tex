...
The software architecture of \gtopt{} is organized around four core
principles:
...
A comprehensive Python toolchain (16 registered CLI tools) is provided
for data preparation, conversion, and validation:
