...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.2.6"
  WORKING_DIRECTORY "/home/runner/work/gtopt/gtopt/test/build/_deps/daw_utf_range-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/gtopt/gtopt/test/build/_deps/daw_utf_range-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/gtopt/gtopt/test/build/_deps/daw_utf_range-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
