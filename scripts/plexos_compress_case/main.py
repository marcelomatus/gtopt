...
the PLEXOS PCP bundles in ``support/plexos/`` (CEN Programa de
...
Examples::
    ...
    plexos_compress_case support/plexos
    plexos_compress_case support/plexos --no-unwrap
    plexos_compress_case --decompress support/plexos
    plexos_compress_case --decompress support/plexos --rewrap
    plexos_compress_case support/plexos --codec zstd --codec-args "-19"
"""
