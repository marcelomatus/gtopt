/**
 * @file      scene.hpp
 * @brief     Defines the Scene structure and related types for optimization
 * scenarios
 * @date      Wed Mar 26 12:11:10 2025
 * @author    marcelo
 * @copyright BSD-3-Clause
 *
 * This module defines the Scene structure which represents a distinct scenario
 * grouping in a multi-scenario optimization problem. Each scene contains
 * configuration for a set of scenarios in the optimization.
 */
...
/**
 * @struct Scene
 * @brief Represents a scene (scenario grouping) in a multi-scenario
 * optimization problem
 *
 * A scene groups together a set of scenarios in the optimization process with
 * common configuration. This allows modeling problems with distinct scenario
 * sets like different weather conditions, demand patterns, etc.
 */
struct Scene
{
   ...
   * @note Uses std::dynamic_extent to indicate all remaining scenarios when
   * unspecified
   */
