...
TEST_CASE("StateVariable key method")
{
  ...
  {
    auto key = StateVariable::key("TestClass", 123, "col_name", 
                                PhaseIndex{1}, StageUid{2});
  ...
  {
    auto key1 = StateVariable::key("Class1", 1, "col1", PhaseIndex{1}, StageUid{1});
    auto key2 = StateVariable::key("Class1", 1, "col1", PhaseIndex{1}, StageUid{1});
    auto key3 = StateVariable::key("Class2", 1, "col1", PhaseIndex{1}, StageUid{1});
    auto key4 = StateVariable::key("Class1", 2, "col1", PhaseIndex{1}, StageUid{1});
...
TEST_CASE("StateVariable construction and basic properties")
{
  ...
  {
    StateVariable var({SceneIndex{1}, PhaseIndex{2}}, 3);
